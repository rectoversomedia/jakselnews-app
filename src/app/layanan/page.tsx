...
const layananJaksel = [
  ...
  { id: 5, title: 'PKH', desc: 'Program Keluarga', icon: '👨‍👩‍👧', color: 'bg-teal-500' },
  ...
  { id: 8, title: 'Indonesia Pintar', desc: 'Bantuan Pendid', icon: '🌟', color: 'bg-yellow-500' },
  ...
  // Kesehatan
  { id: 11, title: 'Puskesmas', desc: 'Pusat Kesehatan', icon: '🏥', color: 'bg-red-400' },
  ...
  { id: 17, title: 'Pajak Kend', desc: 'Cek & Bayar', icon: '🚗', color: 'bg-amber-600' },
  ...
  // Transportasi
  { id: 21, title: 'MRT', desc: 'Rute & Jadwal', icon: '🚇', color: 'bg-red-500' },
  { id: 22, title: 'KRL', desc: 'Rute & Jadwal', icon: '🚆', color: 'bg-blue-500' },
  { id: 23, title: 'TransJakarta', desc: 'Rute & Halte', icon: '🚌', color: 'bg-yellow-500' },
  { id: 24, title: 'LRT', desc: 'Rute & Jadwal', icon: '🚝', color: 'bg-cyan-500' },
  // Kecamatan & Kelurahan
  { id: 25, title: 'KUA', desc: 'KUA Kecamatan', icon: '🏢', color: 'bg-slate-600' },
  { id: 26, title: 'Kelurahan', desc: 'Layanan Kelurahan', icon: '📋', color: 'bg-gray-600' },
  { id: 27, title: 'Kecamatan', desc: 'Layanan Kecamatan', icon: '🏗️', color: 'bg-zinc-600' },
  { id: 28, title: 'RPTRA', desc: 'Taman Bermain', icon: '🎪', color: 'bg-pink-400' },
  // Lainnya
  { id: 29, title: 'Cuaca', desc: 'Info Cuaca', icon: '🌤️', color: 'bg-amber-400' },
  { id: 30, title: 'Banjir', desc: 'Info Banjir', icon: '🌊', color: 'bg-blue-400' },
  { id: 31, title: 'Listrik', desc: 'Cek Tagihan', icon: '💡', color: 'bg-yellow-500' },
  { id: 32, title: 'Air', desc: 'Perumda Air', icon: '🚰', color: 'bg-blue-500' },
  { id: 33, title: 'Gas', desc: 'PGN Gas', icon: '🔥', color: 'bg-orange-500' },
  { id: 34, title: 'Internet', desc: 'Provider', icon: '📶', color: 'bg-indigo-500' },
  { id: 35, title: 'Pasar', desc: 'Info Pasar', icon: '🏪', color: 'bg-green-600' },
  { id: 36, title: 'Parkir', desc: 'Zona Parkir', icon: '🅿️', color: 'bg-gray-500' },
  { id: 37, title: 'Sampah', desc: 'Layanan Sampah', icon: '🗑️', color: 'bg-green-500' },
  { id: 38, title: 'Datun', desc: 'Layanan Hukum', icon: '⚖️', color: 'bg-slate-700' },
];
      ...
      <div className="px-4 py-4">
        <div className="grid grid-cols-4 gap-2">
          {layananJaksel.map((item) => (
            ...
            >
              <div className={`w-10 h-10 ${item.color} rounded-xl flex items-center justify-center text-xl mb-1.5`}>
                {item.icon}
              </div>
