  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        {/* Hero: Logo/Brand (kiri) + Artikel Terpopuler (kanan) */}
            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-4 flex flex-col items-center justify-center py-8">
                <div className="text-center">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900 mb-1">Jakselnews</h1>
                  <p className="text-sm text-gray-500">Portal Berita Jakarta Selatan</p>
                  <div className="mt-4 flex items-center justify-center gap-3">
                    <a
                      href="https://instagram.com/jakselnews"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 bg-gradient-to-br from-pink-500 to-rose-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-pink-200"
                    >
                    ...
                    <a
                      href="https://twitter.com/jakselnews"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 bg-gradient-to-br from-sky-500 to-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-sky-200"
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <a
                      href="https://wa.me/6281234567890"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-green-200"
                    >
                  ...
                  <div className="mt-5 pt-4 border-t border-gray-100">
                    <Link
                      href="/artikel"
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-red-500 to-rose-500 text-white text-sm font-semibold rounded-xl hover:shadow-lg hover:shadow-red-200 transition-all"
                    >
