  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        {/* Hero: Logo+Social (kiri atas) + Breaking News Slider (kiri bawah) | Artikel Terpopuler (kanan) */}
        <section className="bg-white border-b border-gray-100">
          <div className="max-w-6xl mx-auto px-6 py-5">
            <div className="grid grid-cols-12 gap-6">
              {/* Kiri: Logo+Social di atas, Breaking News Slider di bawah */}
              <div className="col-span-8 flex flex-col gap-4">
                {/* Logo + Social Icons */}
                <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-4 border border-gray-100 flex items-center gap-4">
                  <img
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-semibold text-gray-700 mb-2">Portal Berita Warga Jakarta Selatan</p>
                    <div className="flex items-center gap-2">
                      <a href="https://instagram.com/jakselnews" target="_blank" rel="noopener noreferrer"
                        className="w-7 h-7 bg-gradient-to-br from-pink-500 to-rose-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                      ...
                      <a href="https://twitter.com/jakselnews" target="_blank" rel="noopener noreferrer"
                        className="w-7 h-7 bg-gradient-to-br from-sky-500 to-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="white"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                      </a>
                      <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer"
                        className="w-7 h-7 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
