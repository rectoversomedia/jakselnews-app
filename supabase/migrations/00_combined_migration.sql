...
-- =====================================================
-- Run all 3 migrations in one file to avoid policy conflicts.
-- This replaces 001_initial_schema + 002_rls_policies + 003_rls_policies_fix
-- =====================================================
...
DROP POLICY IF EXISTS "profiles_viewable_by_everyone" ON public.profiles;
...
-- Reports policies (public read + insert)
...
-- is_admin() helper (drop first if exists)
...
-- Note: handle_new_user function created below
...
-- Storage policy (allow public access to reports-media bucket)
